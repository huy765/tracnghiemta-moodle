...
$string['backquiz'] = 'Back to the r quiz';
...
$string['eventeditpageviewed'] = 'r quiz edit page viewed';
$string['eventresponsesviewed'] = 'r quiz responses viewed';
...
$string['modulename'] = 'r quiz';
$string['modulenameplural'] = 'r quizzes';
$string['next'] = 'Next >>';
...
$string['nosessions'] = 'This r quiz has not yet been attempted';
...
$string['pluginadministration'] = 'r quiz administration';
$string['pluginname'] = 'r quiz';
$string['prevquestion'] = 'Previous question';
$string['privacy:metadata:rquiz_submitted'] = 'Details of an answer given to a r quiz question';
$string['privacy:metadata:rquiz_submitted:answerid'] = 'The ID of the answer that was selected';
$string['privacy:metadata:rquiz_submitted:questionid'] = 'The ID of the question that has been answered';
$string['privacy:metadata:rquiz_submitted:sessionid'] = 'The ID of the session the answer was given in';
$string['privacy:metadata:rquiz_submitted:userid'] = 'The ID of the user that gave the answer';
...
$string['questionslist'] = 'Questions in this r quiz: ';
...
$string['rquiz:addinstance'] = 'Add a new r quiz';
$string['rquiz:attempt'] = 'Attempt a quiz';
$string['rquiz:control'] = 'Start / control a quiz';
$string['rquiz:seeresponses'] = 'View the responses to a quiz';
$string['rquiz:editquestions'] = 'Edit the questions for a quiz';
$string['rquizintro'] = 'Introduction';
$string['rquizsettings'] = 'r quiz settings';
