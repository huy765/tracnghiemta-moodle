...
// Translation: Lê Quốc Huy ( The Jolash ).
...
// Capabilities.
$string['rquiz:control'] = 'Start / Test Kontrolle';
$string['rquiz:attempt'] = 'Test versuchen';
$string['rquiz:seeresponses'] = 'Testantworten sehen';
$string['rquiz:editquestions'] = 'Fragen für einen Test bearbeiten';

// Editing the r quiz settings.
