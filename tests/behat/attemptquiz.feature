...
Feature: Students can attempt a quiz under the control of a teacher
  Background:
    ...
    And I add a "r quiz" to section "1" and I fill the form with:
      | r quiz         | Test r quiz                |
      | Introduction          | Test the r quiz is working |
      | Default question time | 15                                |
    And I follow "Test r quiz"
  ...
  Scenario: Teacher starts quiz, then students attempt it
    ...
    # Question 1 results.
    Then I should see "Sheffield" in the "li.rquiz-answer-pos-1" "css_element"
    And I should see "1" in the "li.rquiz-answer-pos-1" "css_element"
    And I should see "Manchester" in the "li.rquiz-answer-pos-2" "css_element"
    And I should see "0" in the "li.rquiz-answer-pos-2" "css_element"
    And I should see "London" in the "li.rquiz-answer-pos-3" "css_element"
    And I should see "0" in the "li.rquiz-answer-pos-3" "css_element"
    ...
    And I press "Reconnect to quiz"
    And I wait "10" seconds
    Then I should see "200" in the "li.rquiz-answer-pos-1" "css_element"
    And I should see "0" in the "li.rquiz-answer-pos-1" "css_element"
    And I should see "60 million" in the "li.rquiz-answer-pos-2" "css_element"
    And I should see "1" in the "li.rquiz-answer-pos-2" "css_element"
    And I should see "2.5 million" in the "li.rquiz-answer-pos-3" "css_element"
    And I should see "0" in the "li.rquiz-answer-pos-3" "css_element"
    ...
    And I press "Reconnect to quiz"
    And I wait "10" seconds
    Then I should see "Red" in the "li.rquiz-answer-pos-1" "css_element"
    And I should see "0" in the "li.rquiz-answer-pos-1" "css_element"
    And I should see "Green" in the "li.rquiz-answer-pos-2" "css_element"
    And I should see "0" in the "li.rquiz-answer-pos-2" "css_element"
    And I should see "Purple" in the "li.rquiz-answer-pos-3" "css_element"
    And I should see "1" in the "li.rquiz-answer-pos-3" "css_element"
    # Final results.
    When I press "Next"
